                            ...
                            if (tax_row.account_head === cuenta) {
                                ...
                                frappe.call({
                                    ...
                                    callback: function callback(data) {
                                        ...
                                        frm.doc.taxes[index].rate = parseFloat(otro_impuesto / valor_con_iva);
                            ...
                            if (tax_row.account_head === undefined) {
                                frappe.call({
                                    ...
                                    callback: function callback(data) {
                                        ...
                                        frm.doc.taxes[index].rate = parseFloat(otro_impuesto / (valor_con_iva / (1 + 12)));
                        ...
                        if (tax_row.account_head == cuenta) {
                            ...
                            frappe.call({
                                ...
                                callback: function callback(data) {
                                    ...
                                    frm.doc.taxes[index].rate = otro_impuesto / valor_con_iva;
                                    frm.doc.taxes[index].description = 'Impuesto';
                                }
                            });
                        }
