...
function generar_tabla_html(frm) {
    ...
    if (frm.doc.items.length > 0) {
        var mi_array = frm.doc.items;
        var mi_array_dos = Array.from(mi_array);
...
frappe.ui.form.on("Sales Invoice", {
    ...
    validate: function validate(frm) {
...
frappe.ui.form.on("Sales Invoice Item", {
    ...
    shs_amount_for_back_calc: function shs_amount_for_back_calc(frm, cdt, cdn) {
...
frappe.ui.form.on("Delivery Note", {
    ...
    shs_dn_nit: function shs_dn_nit(frm) {
        valNit(frm.doc.shs_dn_nit, frm.doc.customer, frm);
    },
    discount_amount: function discount_amount(frm) {
...
frappe.ui.form.on("Delivery Note Item", {
    items_remove: function items_remove(frm) {
...
frappe.ui.form.on("Sales Order", {
    ...
    shs_so_nit: function shs_so_nit(frm) {
...
function coti_insertar_fila_otro_impuesto(frm, cdt, cdn) {
    ...
    frm.doc.items.forEach(function (item_row_i, indice) {
        if (item_row_i.name === cdn) {
            ...
            if (cuenta) {
                if (!coti_buscar_cuenta(frm, cuenta)) {
...
frappe.ui.form.on("Purchase Receipt", {
    ...
    facelec_nit_prproveedor: function facelec_nit_prproveedor(frm) {
...
frappe.ui.form.on("Purchase Order", {
    ...
    facelec_po_nit: function facelec_po_nit(frm) {
...
frappe.ui.form.on("Supplier Quotation", {
    ...
    shs_spq_nit: function shs_spq_nit(frm) {
