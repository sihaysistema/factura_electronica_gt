...
frappe.ui.form.on("Purchase Receipt", {
    onload_post_render: function (frm, cdt, cdn) {
        ...
        frm.fields_dict.items.grid.wrapper.on('focusout blur', 'input[data-fieldname="item_code"][data-doctype="Purchase Receipt Item"]', function (e) {
        ...
        frm.fields_dict.items.grid.wrapper.on('blur', 'input[data-fieldname="uom"][data-doctype="Purchase Receipt Item"]', function (e) {
            shs_purchase_receipt_calculation(frm, cdt, cdn);
        });
        ...
        frm.fields_dict.items.grid.wrapper.on('blur', 'input[data-fieldname="item_name"][data-doctype="Purchase Receipt Item"]', function (e) {
            purchase_receipt_each_item(frm, cdt, cdn);
        });
        ...
        // Do not refresh with each_item in Mouse leave! just recalculate
        frm.fields_dict.items.grid.wrapper.on('blur', 'input[data-fieldname="qty"][data-doctype="Purchase Receipt Item"]', function (e) {
            purchase_receipt_each_item(frm, cdt, cdn);
            shs_purchase_receipt_calculation(frm, cdt, cdn);
        });
