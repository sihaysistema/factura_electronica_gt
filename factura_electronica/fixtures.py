        ...
        "dt": "Translation", "filters": [
            [
                "source_text", "in", [
                    ...
                    "Applies for ISR withholding", "Trade Name",
                    ...
                    "Generate Credit Note", "Reason Adjusment?", "CANCEL DOCUMENT FEL",
                    "Are you sure you want to proceed to cancell a Sales Invoice FEL?",
                    "Cancell Sales Invoice FEL", "Reason for cancellation?", "DEBIT NOTE FEL",
                    "Are you sure you want to proceed to generate a electronic debit note?",
                    ...
                    "FEL: Check if the item applies to discount to show in electronic invoice generation.",
                    "Are you sure to cancel the current electronic document?", "Electronic Document Canceller", "Requested By:",
                    "Authorized By:", "Code and Item Image", "Name, Quantity, Price, Destination Warehouse",
                    "Name, Quantity, Price, Source Warehouse", "Codigo Unidad de Medida",
                    "Codigo de 3 caracteres para unidad de medida a enviar con Factura Electronica. Previamente validado con INFILE.",
                    "Series Configuration For Purchase Invoices", "Purchase Invoice Series", "Combination Of Phrases",
                    "FEL Combinations", "Access Number FCAM", "Series Configuration For Sales Invoices", "Tax per category",
                    "TAX FACELEC", "Is Discount?", "Select A File Fype", "File Generated!", "Generate and Download",
                    "Generating and saving file", "No es posible generar y descargar el archivo, aun no ha generado el reporte",
                    "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November",
                    "December", "Name Of Owner", "FACELEC: If the company is owned by a single person, enter the owner's name.",
