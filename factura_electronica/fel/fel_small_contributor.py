...
class SmallContributor:
    ...
    def sender(self):
        ...
        try:
            ...
            if frappe.db.get_value('Configuracion Factura Electronica',
                ...
                nom_comercial = frappe.db.get_value('Configuracion Factura Electronica', {'name': self.__config_name}, 'nombre_empresa_prueba')
            ...
            if longitems != 0:
                ...
                for i in range(0, longitems):
                    ...
                    if apply_oil_tax:
                        ...
                        precio_uni = flt((
                            self.__dat_items[i]['rate'] - self.__dat_items[i]['facelec_tax_rate_per_uom']) + desc_item_fila, self.__precision)
    ...
    def adendas(self):
        ...
        try:
            ...
            return False, 'No se pudo obtener data de la factura {} para generar adendas, Error: {}'.format(
                self.serie_factura, str(frappe.get_traceback()))
