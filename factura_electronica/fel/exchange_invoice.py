...
class SalesExchangeInvoice:
    ...
    def build_invoice(self):
        ...
        try:
            ...
            fields_sales_invoice = ['posting_date', 'posting_time', 'currency', 'company', 'company_address', 'nit_face_customer',
                                    ...
                                    'facelec_total_items_overview', 'access_number_fel']
            ...
            if status_validate.get('status'):  # True/False
                ...
                with open('PREVIEW-FACTURA-CAMBIARIA.xml', 'w') as f:
                    f.write(xmltodict.unparse(self.__base_peticion, pretty=True))

                with open('PREVIEW-FACTURA-CAMBIARIA.json', 'w') as f:
    ...
    def totals(self):
        ...
        try:
            ...
            # Escenario PETROLEO (Si hay algun producto con IDP se agrega)
            if is_idp:
    ...
    def complement(self):
        ...
        try:
            ...
            msg_comple = _('La seccion de pagos (complemento) no pudo ser generada, por favor verifique que que exista un pago programado\
                e intente de nuevo.')
    ...
    def request_electronic_invoice(self):
        ...
        try:
            ...
            with open("peticion-cambiaria-fel.json", "w") as file:
            ...
            with open('RESPONSE-FACTURA-CAMBIARIA.json', 'w') as f:
    ...
    def save_answers(self):
        ...
        try:
            ...
            if not frappe.db.exists('Envio FEL', {'name': self.__response_ok['uuid']}):
                ...
                fel_folder = create_folder('FACT_FEL_CAMB', fel_folder_container)
